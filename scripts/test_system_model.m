...
function [result, ref_data_sys] = test_system_model(filepath, reffile,model, method, cached_ref_data)
...
%disp(testfilelist)
    ...
    if cached_ref_data==0
        ...
        featstruct = method.analysis.analysisfunction(audio, method.analysis, [systemcode,reffilebasename]);
