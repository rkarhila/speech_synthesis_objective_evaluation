function [significants_by_type, non_significants_by_type] = get_significance_distances_by_systemtype(objective_scores, subjective_scores, opinion_matrix, systems, systemtypes)
